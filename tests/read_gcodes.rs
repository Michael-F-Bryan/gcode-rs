...
use gcode::{Gcode, Mnemonic, Number, Span, Value, Word};
...
fn read_each_line_of_a_file() {
    ...
    let should_be = vec![
        ...
        Gcode::new(Mnemonic::General, Number::from(0.0), Span::new(63, 65, 3)),
        Gcode::new(Mnemonic::General, Number::from(90.0), Span::new(66, 69, 3)),
        Gcode::new(Mnemonic::General, Number::from(40.0), Span::new(70, 73, 3)),
        Gcode::new(Mnemonic::General, Number::from(21.0), Span::new(74, 77, 3)),
        Gcode::new(Mnemonic::General, Number::from(17.0), Span::new(78, 81, 3)),
        Gcode::new(Mnemonic::General, Number::from(94.0), Span::new(82, 85, 3)),
        Gcode::new(Mnemonic::General, Number::from(80.0), Span::new(86, 89, 3)),
        Gcode::new(
            Mnemonic::General,
            Number::from(54.0),
            Span::new(98, 116, 4),
